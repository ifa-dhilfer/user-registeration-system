...
$sql="insert into users (usercheck,passcheck,emailcheck,birthdaydaycheck,birthdaymonthcheck,birthdayyearcheck,educationcheck,nameoftheinstitutioncheck,resumecheck,gendercheck) values ('{$usercheck}','{$passcheck}','{$emailcheck}','{$birthdaydaycheck}','{$birthdaymonthcheck}','{$birthdayyearcheck}','{$educationcheck}','{$nameoftheinstitutioncheck}','{$resumecheck}','{$gendercheck}')";
if($con->query($sql))
{
	echo "data saved...!";
}
